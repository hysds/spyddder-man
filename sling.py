...
if __name__ == "__main__":
    ...
    try:
        sling(args.download_url, args.repo_url, args.prod_name, args.file_type,
              args.prod_date, prod_met, args.oauth_url, args.force, args.force_extract)
    except Exception as e:
